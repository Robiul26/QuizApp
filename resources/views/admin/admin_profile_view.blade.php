                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ @Auth::user()->photo ? asset('upload/admin_images/' . Auth::user()->photo) : asset('upload/default.png') }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="profile-photo"
                                                src="{{ @Auth::user()->photo ? asset('upload/admin_images/' . Auth::user()->photo) : asset('upload/default.png') }}"
